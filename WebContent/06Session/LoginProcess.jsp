...
<%
	...
	*/
	...
	if (memberDTO.getId() != null) {
		//저장된 값이 있다면... 세션영역에 아아디, 패스워드, 이름을 속성으로 저장한다.
		...
		session.setAttribute("USER_REGIDATE", memberDTO.getRegidate());
	...
	*/
	...
	if (memberinfo.get("id") != null) {
		...
		session.setAttribute("USER_REGIDATE", memberinfo.get("regidate"));
